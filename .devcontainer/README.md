...
You can bind mount a shell script to `/root/.welcome.sh` to replace the [current welcome script](https://github.com/qdm12/nodedevcontainer/blob/master/shell/.welcome.sh).
